...
const settingsSchema = new Schema({
	analysis_metrics: {
		...
		default: [
			{ id: 'highly_churn_file', name: 'Code Churn', checked: false, coefficient: 1.5, source: 'robot' },
			{ id: 'highly_buggy_file', name: 'Previous Bug Frequency', checked: false, coefficient: 1.5, source: 'robot' },
			{ id: 'co_changed', name: 'Co-changed Files', checked: false, coefficient: 1.5, source: 'robot' },
